...
echo "<b>SMART SECURITY</b>";
echo "<p>Smart-home monitoring products mean you can set up cameras to check on your home, even if you're in another
country.</p>";

echo "You can either watch a live stream through your phone or tablet, or just get alerts when the motion sensor is
triggered.";

echo"<p><b>SMART ENERGY</b><br>
